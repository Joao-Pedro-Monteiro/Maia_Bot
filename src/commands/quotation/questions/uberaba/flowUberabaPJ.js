...
class FlowUberabaPJ {
    static async iniciar(state) {
        console.log("Cotação Uberaba PJ, iniciada ......\n....\n..");
        // Já sabemos que é PJ e Uberaba
    ...
    static async execute(userInput, state) {
        ...
        switch (cliente.lastQuestion) {
            ...
            default:
                ...
                return "⚠️ controlador: Ocorreu um erro. Por favor, digite 'Q' para reiniciar.";
        }
    }
    ...
    static perguntarSegmentacao(cliente) {
        if (cliente.tipoPlano === 'Nosso Médico') { //? SEGMENTAÇÃO 'NOSSO MÉDICO'
            ...
            return "⚠️ perguntarSegmentacao: Ocorreu um erro. Por favor, digite 'Q' para reiniciar.";
        }
    }
    ...
    static obterTabelaPrecos(cliente) {
        try {
            ...
            if (cliente.qtdBeneficiario === '30-99' && cliente.tipoPlano === 'Nosso Médico') {
                ...
                if (!tabelaHappyVidaPJ.PJ.Uberaba['30-99']['Nosso Médico']) {
                    // Se não existir, procuramos na raiz
                    if (tabelaHappyVidaPJ.PJ.Uberaba['Nosso Médico']) {
                        // Se achou na raiz, usa essa estrutura
                        const baseNossoMedico = tabelaHappyVidaPJ.PJ.Uberaba['Nosso Médico'][cliente.coparticipacao][cliente.segmentacao];
                    ...
                    return tabelaHappyVidaPJ.PJ.Uberaba['2-29']['Nosso Médico'][cliente.coparticipacao][cliente.segmentacao][cliente.acomodacao];
                }
            }
            ...
            if (cliente.qtdBeneficiario === '2-29') {
                ...
                tabela = tabelaHappyVidaPJ.PJ.Uberaba["2-29"][cliente.tipoPlano][cliente.coparticipacao][cliente.segmentacao][cliente.acomodacao];
            } else if (cliente.qtdBeneficiario === '30-99') {
                ...
                if (cliente.assistencia) {
                    if (cliente.segmentacao === 'AMB+HOSP+OBST' && cliente.acomodacao === 'APART' && 
                        ...
                        tabela = tabelaHappyVidaPJ.PJ.Uberaba['30-99'][cliente.tipoPlano][cliente.coparticipacao][cliente.segmentacao][cliente.acomodacao];
                    } else {
                        // Caso normal com subdivisão por assistência médica
                        tabela = tabelaHappyVidaPJ.PJ.Uberaba['30-99'][cliente.tipoPlano][cliente.coparticipacao][cliente.segmentacao][cliente.acomodacao][cliente.assistencia];
                    }
                } else {
